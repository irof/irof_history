	...
	public void nakamapSetup(final Activity activity) {
		Runnable command = new Runnable() {
			...
			public void run() {
				...
				String NAKAMAP_CLIENT_ID = m_r
						.getString(R.string.nakamap_clientid);
				String newAccountBaseName = m_r
						.getString(R.string.newAccountBaseName);
				Nakamap.setup(activity.getApplicationContext(),
						NAKAMAP_CLIENT_ID, newAccountBaseName);
			}
		};
	...
	public void nakamapSetup(final Application app) {
		Runnable command = new Runnable() {
			...
			public void run() {
				...
				String newAccountBaseName = m_r
						.getString(R.string.newAccountBaseName);
				Nakamap.setup(app.getApplicationContext(), NAKAMAP_CLIENT_ID,
						newAccountBaseName);
			}
		};
